...
export default function HomePage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 md:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-white leading-tight">
            ...
            Soft Trims and <span className="text-cyan-blue">NVH Solutions</span>
            <br />
      ...
      <section ref={sectionRef} className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div
          ...
          } ${titlePosition === "top" ? "content-padding-top" : "content-padding-none"}`}
        >
          {/* Main Content Grid */}
            ...
            <div className="relative space-y-16">
                ...
                <div
                  className={`absolute w-1 bg-gradient-to-b transition-all duration-700 ease-out ${
                    activeScrollSection === "passenger"
                      ? "from-cyan-400 via-white to-cyan-400 top-0 h-1/2 shadow-lg shadow-cyan-400/50 glow-shadow"
                      : activeScrollSection === "commercial"
                        ? "from-cyan-400 via-white to-cyan-400 top-1/2 h-1/2 shadow-lg shadow-cyan-400/50 glow-shadow"
              ...
              <div
                ...
                className={`cursor-pointer transition-all duration-700 ease-out pl-8 ${
                  activeScrollSection === "passenger"
                    ? "opacity-100 scale-105 translate-x-2 cyan-glow"
                    : activeScrollSection === "commercial"
                      ? "opacity-40 scale-95"
                      : "opacity-70"
                }`}
 ...
 {/* Contact Section */}
 <section
  className="py-16 px-16 md:px-24 lg:px-32 xl:px-48 2xl:px-64 flex items-center justify-center bg-blue-custom"
>
